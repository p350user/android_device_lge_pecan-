...
BOARD_CUSTOM_BRCM_PATCHRAM_PLUS := ../../../device/lge/pecan/files/brcm_patchram_plus.c

#BOARD_CUSTOM_LIGHTS_FILE := ../../../device/lge/pecan/liblights/lights.c
...
BOARD_EGL_CFG := device/lge/pecan/files/lib/egl/egl.cfg
